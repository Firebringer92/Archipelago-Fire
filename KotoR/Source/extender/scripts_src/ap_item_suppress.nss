// Shared item-suppression handler for modules with no existing
// vanilla Mod_OnAcquirItem script. Destroys the just-acquired item if its
// resref isn't in the AP-allowed set (quest_dependent OR included_as_item
// OR shop_randomize in gear_items.json) -- see patch_item_suppression.py.
#include "kse"
