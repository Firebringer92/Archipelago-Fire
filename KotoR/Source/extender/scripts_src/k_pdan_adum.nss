// Store-open marker wrapper for k_pdan_adum (module danm14aa).
...
void main()
{
    ExecuteScript("apo_st03", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(53, "AP|STOREOPENED|k_pdan_adum|credits=" + IntToString(GetGold(oPC)));
}
