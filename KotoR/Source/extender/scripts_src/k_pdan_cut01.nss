// Trampoline for k_pdan_cut01 -- part of the Dantooine Jedi Council
...
void main()
{
    ...
    if (sModule == "danm13")
    {
        HandleBastilaCarthGate("apo_danm13_cut01_orig", "k_pdan_cut01_danm13");
    }
    else if (sModule == "danm14ab")
    {
        HandleBastilaCarthGate("apo_danm14ab_cut01_orig", "k_pdan_cut01_danm14ab");
    }
    else
    {
        ExecuteScript("apo_danm13_cut01_orig", OBJECT_SELF);
    }
}
