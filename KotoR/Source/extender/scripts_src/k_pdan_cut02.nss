// Trampoline for k_pdan_cut02 -- part of the Dantooine Jedi Council
...
void main()
{
    ...
    if (sModule == "danm13")
    {
        HandleBastilaCarthGate("apo_danm13_cut02_orig", "k_pdan_cut02_danm13");
    }
    else if (sModule == "danm14ab")
    {
        HandleBastilaCarthGate("apo_danm14ab_cut02_orig", "k_pdan_cut02_danm14ab");
    }
    else
    {
        ExecuteScript("apo_danm13_cut02_orig", OBJECT_SELF);
    }
}
