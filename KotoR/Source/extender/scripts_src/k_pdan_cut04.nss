// Trampoline for k_pdan_cut04 -- part of the Dantooine Jedi Council
...
void main()
{
    ...
    if (sModule == "danm13")
    {
        HandleBastilaCarthGate("apo_danm13_cut04_orig", "k_pdan_cut04_danm13");
    }
    else if (sModule == "danm14ab")
    {
        ExecuteScript("apo_danm14ab_cut04_orig", OBJECT_SELF);
    }
    else
    {
        ExecuteScript("apo_danm13_cut04_orig", OBJECT_SELF);
    }
}
