// Trampoline for k_pdan_cut06 -- part of the Dantooine Jedi Council
...
void main()
{
    ...
    if (sModule == "danm13")
    {
        HandleBastilaCarthGate("apo_danm13_cut06_orig", "k_pdan_cut06_danm13");
    }
    else if (sModule == "danm14ab")
    {
        HandleBastilaCarthGate("apo_danm14ab_cut06_orig", "k_pdan_cut06_danm14ab");
    }
    else
    {
        ExecuteScript("apo_danm13_cut06_orig", OBJECT_SELF);
    }
}
