// Store-open marker wrapper for k_pdan_droids (module danm13).
...
void main()
{
    ExecuteScript("apo_st00", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(50, "AP|STOREOPENED|k_pdan_droids|credits=" + IntToString(GetGold(oPC)));
}
