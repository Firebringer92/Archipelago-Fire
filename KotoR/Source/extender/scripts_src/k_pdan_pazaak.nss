// Store-open marker wrapper for k_pdan_pazaak (module danm13).
...
void main()
{
    ExecuteScript("apo_st02", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(52, "AP|STOREOPENED|k_pdan_pazaak|credits=" + IntToString(GetGold(oPC)));
}
