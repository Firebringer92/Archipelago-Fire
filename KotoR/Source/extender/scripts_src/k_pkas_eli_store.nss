// Store-open marker wrapper for k_pkas_eli_store (module kas_m22aa).
...
void main()
{
    ExecuteScript("apo_st04", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(54, "AP|STOREOPENED|k_pkas_eli_store|credits=" + IntToString(GetGold(oPC)));
}
