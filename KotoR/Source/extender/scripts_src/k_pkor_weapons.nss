// Store-open marker wrapper for k_pkor_weapons (module korr_m33aa).
...
void main()
{
    ExecuteScript("apo_st09", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(59, "AP|STOREOPENED|k_pkor_weapons|credits=" + IntToString(GetGold(oPC)));
}
