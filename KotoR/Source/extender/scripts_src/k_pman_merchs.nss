// Store-open marker wrapper for k_pman_merchs (module manm26ad).
...
void main()
{
    ExecuteScript("apo_st15", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(65, "AP|STOREOPENED|k_pman_merchs|credits=" + IntToString(GetGold(oPC)));
}
