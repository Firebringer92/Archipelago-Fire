// Store-open marker wrapper for k_pman_merchsk (module manm26ad).
...
void main()
{
    ExecuteScript("apo_st16", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(66, "AP|STOREOPENED|k_pman_merchsk|credits=" + IntToString(GetGold(oPC)));
}
