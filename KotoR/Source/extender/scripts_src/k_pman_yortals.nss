// Store-open marker wrapper for k_pman_yortals (module manm26ab).
...
void main()
{
    ExecuteScript("apo_st14", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(64, "AP|STOREOPENED|k_pman_yortals|credits=" + IntToString(GetGold(oPC)));
}
