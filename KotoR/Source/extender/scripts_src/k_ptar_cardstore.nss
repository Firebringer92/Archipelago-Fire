// Store-open marker wrapper for k_ptar_cardstore (module tar_m03ae).
...
void main()
{
    ExecuteScript("apo_st23", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(73, "AP|STOREOPENED|k_ptar_cardstore|credits=" + IntToString(GetGold(oPC)));
}
