// Store-open marker wrapper for k_ptar_janicesto (module tar_m02ab).
...
void main()
{
    ExecuteScript("apo_st20", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(70, "AP|STOREOPENED|k_ptar_janicesto|credits=" + IntToString(GetGold(oPC)));
}
