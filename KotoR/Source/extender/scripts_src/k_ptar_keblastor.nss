// Store-open marker wrapper for k_ptar_keblastor (module tar_m02ac).
...
void main()
{
    ExecuteScript("apo_st21", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(71, "AP|STOREOPENED|k_ptar_keblastor|credits=" + IntToString(GetGold(oPC)));
}
