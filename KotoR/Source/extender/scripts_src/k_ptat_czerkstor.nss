// Store-open marker wrapper for k_ptat_czerkstor (module tat_m17ag).
...
void main()
{
    ExecuteScript("apo_st29", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(79, "AP|STOREOPENED|k_ptat_czerkstor|credits=" + IntToString(GetGold(oPC)));
}
