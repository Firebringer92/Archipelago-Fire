// Store-open marker wrapper for k_ptat_gaffistor (module tat_m17ag).
...
void main()
{
    ExecuteScript("apo_st30", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(80, "AP|STOREOPENED|k_ptat_gaffistor|credits=" + IntToString(GetGold(oPC)));
}
