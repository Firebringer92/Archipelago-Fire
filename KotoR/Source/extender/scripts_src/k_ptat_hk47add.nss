// Suppression wrapper for hk47's real story recruitment script
// (originally tat_m17ac's k_ptat_hk47add, preserved as apo_hk47_orig).
//
...
//
// GUARD (added 2026-08-31): if NPC_HK_47 is ALREADY available when this
// fires, our own companion_hk47 AP arm already ran (early item, or an
// admin re-grant) and hk47 is already an active party member. Confirmed
// live: running apo_hk47_orig + RemoveAvailableNPC on an
...
void main()
{
    ...
    {
        ExecuteScript("apo_hk47_orig", OBJECT_SELF);
        RemoveAvailableNPC(NPC_HK_47);
        KSE_Diag(34, "AP|SUPPRESSED|companion_hk47");
    }
    else
    {
        KSE_Diag(34, "AP|SUPPRESSED|companion_hk47|skipped_already_recruited");
    }
    ...
    KSE_Diag(22, "AP|CHECK|COMPANION|3");
}
