// Store-open marker wrapper for k_ptat_junixstor (module tat_m17af).
...
void main()
{
    ExecuteScript("apo_st28", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(78, "AP|STOREOPENED|k_ptat_junixstor|credits=" + IntToString(GetGold(oPC)));
}
