// Store-open marker wrapper for k_ptat_yukastore (module tat_m17ac).
...
void main()
{
    ExecuteScript("apo_st26", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(76, "AP|STOREOPENED|k_ptat_yukastore|credits=" + IntToString(GetGold(oPC)));
}
