// Store-open marker wrapper for kor33_czerkstore (module korr_m33aa).
...
void main()
{
    ExecuteScript("apo_st07", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(57, "AP|STOREOPENED|kor33_czerkstore|credits=" + IntToString(GetGold(oPC)));
}
