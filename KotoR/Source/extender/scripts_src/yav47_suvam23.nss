// Store-open marker wrapper for yav47_suvam23 (module liv_m99aa).
...
void main()
{
    ExecuteScript("apo_st11", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(61, "AP|STOREOPENED|yav47_suvam23|credits=" + IntToString(GetGold(oPC)));
}
