// Store-open marker wrapper for yav47_suvam24 (module liv_m99aa).
...
void main()
{
    ExecuteScript("apo_st12", OBJECT_SELF);
    object oPC = GetFirstPC();
    KSE_Diag(62, "AP|STOREOPENED|yav47_suvam24|credits=" + IntToString(GetGold(oPC)));
}
